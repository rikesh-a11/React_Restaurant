  ...
  return (
    <>
      <div className="min-h-screen flex flex-col justify-center items-center lg:px-32 px-5">
        <h2 className="text-4xl font-semibold text-center lg:pt-8 pt-24 pb-10 mt-11">
          Contact Us
        </h2>
          ...
          <div className="bg-[#011c2b] rounded-lg p-6 max-lg:text-center">
            ...
            <ul className="mt-16 space-y-10">
              <li className="flex items-center max-lg:justify-center">
                ...
                >
                  <strong>rikstha@example.com</strong>
                </a>
              </li>
              <li className="flex items-center max-lg:justify-center">
                <svg
              ...
              <li className="flex items-center max-lg:justify-center">
                ...
                <a
                  ...
                  className="text-white text-sm ml-3"
                >
                  <strong>Kumaripati,Lalitpur</strong>
                </a>
              </li>
            </ul>
              ...
              <div className="grid gap-8">
                ...
                <div className=" flex items-center">
                  <input
                    ...
                    className="px-2 py-3 bg-white w-full text-sm text-black border-b-2 focus:border-[#011c2b] outline-none"
                  />
                </div>
                <div className=" flex items-center">
                  <input
